...
#define TXTCL_DATAFILES_MISSING_AUTO "\r" BULLET " The data files are missing. They should automatically download the first time you try to join the game. If not, please go to http://www.deltatao.com/clanlord/trouble.html\r"
